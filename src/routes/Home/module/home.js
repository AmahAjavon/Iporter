...
export function bookCar(){
    return (dispatch, store)=>{
        const nearByTransporters = store().home.nearByTransporters;
        const nearByTransporter = nearByTransporters[Math.floor(Math.random() * nearByTransporters.length)];
        const payload = {
            data:{
                userName:"amah",
                pickUp:{
            ...
            nearByTransporter:{
                socketId:nearByTransporter.socketId,
                transporterId:nearByTransporter.transporterId,
                latitude:nearByTransporter.coordinate.coordinates[1],
                longitude:nearByTransporter.coordinate.coordinates[0]
            }
        };
...
//handle get nearby transporters
function handleGetNearbyTransporters(state, action){
    return update(state, {
        nearByTransporters:{
            $set:action.payload
        }
...
const ACTION_HANDLERS = {
    ...
    GET_NEARBY_TRANSPORTERS:handleGetNearbyTransporters,
